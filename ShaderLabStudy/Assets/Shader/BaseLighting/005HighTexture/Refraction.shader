...
Shader "ShaderEnter/005HighTexture/Reflection"
{
    Properties
    {
    	...
    	_RefractRatio ("Reflection Ratio", Range(0.1,1)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(a2v v)
            {
            	...
            	// 参数1 入射光线方向 参数2 法线 参数3 折射率
            	o.worldRefl = refract(-normalize(o.worldViewDir) , normalize(o.worldNormal), _RefractRatio); //在顶点着色器计算折射 性能比较好
