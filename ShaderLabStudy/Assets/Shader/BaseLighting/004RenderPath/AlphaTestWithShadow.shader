...
Shader "ShaderEnter/002SingleTexture/AlphaTest"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct v2f
            {
                ...
                float2 uv : TEXCOORD2;
            	SHADOW_COORDS(3) //声明一个用于对阴影纹理采样的坐标
                //这个宏的参数需要是下一个可用的插值寄存器的索引值 上面已经用了TEXCOORD0、1、2 所以这里传入3
            };
    ...
    FallBack "Transparent/Cutout/VertexLit"  //使用VertexLit是不行的 保证使用透明度测试的物体可以正确的向其他物体投射阴影
}
